...
var imageCollection = l8
  .filterBounds(roi)
  .filterDate('2014-01-01', '2014-12-31')
  .map(cloudMask);

// 3. Create Mosaic from 11 Feb 2014
var image1 = l8
  .filterDate('2015-01-12', '2015-01-13')
  .map(cloudMask);

var mosaic = image1.mosaic().clip(roi);

// 4. Create 2014 Median Composite for Filling Gaps
var median2014 = imageCollection.median().clip(roi);


// 5. Fill Gaps in Mosaic using Unmasked Areas from Median Composite
var image = mosaic.unmask(median2014);
...
Export.table.toDrive({
  ...
  fileFormat: 'CSV',
  selectors: columns,
  description: 'Samples_LC_SA_2014',
  folder: 'LULC_2014_RF'
});
...
Export.image.toDrive({
    image: lc,
    description: 'LULC_Classification_2014_RF',
    folder: 'LULC_2014_RF', // Change the folder name as needed
...
Export.table.toDrive({
  ...
  folder: 'LULC_2014_RF',
  fileNamePrefix: 'classification_metrics_2014',
  fileFormat: 'CSV',
